...
var onMouseMove = function (e) {
  if (e.pageX > canvasMinX-paddle.width   && e.pageX < canvasMaxX +paddle.width ) {
    paddle.xpos = e.pageX - canvasMinX - (paddle.width/2)  ;
  }
}
...
function onKeyPress(e){
	if (e.keyCode === 80){ //pause game
		...
		}else if (gameState === PLAYING_GAME || gameState === GAME_OVER || gameState === GAME_WON  ){
